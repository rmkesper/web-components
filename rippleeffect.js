...
class RippleEffect {
	...
	add() {
		...
		if(!document.getElementById(_.rippleStyleHolder)){
			...
			50% {
			opacity: calc( ( var(--rpl-opacity-start) - var(--rpl-opacity-end) ) / 2 );
			transform: translate3d(0, 0, 0);
			background-size: calc(var(--rpl-max) * ( ( var(--rpl-scl-end) - var(--rpl-scl-start) ) / 2 ) ) calc(var(--rpl-max) * ( ( var(--rpl-scl-end) - var(--rpl-scl-start) ) / 2 ));
			background-position-x: calc(var(--rpl-dx) - var(--rpl-max) * ( ( var(--rpl-scl-end) - var(--rpl-scl-start) ) / 2 ) / 2);
			background-position-y: calc(var(--rpl-dy) - var(--rpl-max) * ( ( var(--rpl-scl-end) - var(--rpl-scl-start) ) / 2 ) / 2);
			}
			100% {
			...
			animation: ${_.rippleAnimationsName} var(--rpl-ani-duration) var(--rpl-ani-state) forwards;
			}`
